content = [
...

  {
    ...
    material:
      ...
      figure: "missing"
      figure_credits: "Credit: NASA/Kepler Mission"
...

  {
    ...
    material:
      ...
      text: """
        <p>You've successfully completed the Planet Hunters mini-course on Exoplanetary Astrophysics! We hope you enjoyed it, and that you learned some new and interesting things about this fantastic area of research. Please continue your great work on Planet Hunters, so that together we can continue to discover more about our Universe.</p>
        <p>Remember, if you want to review the slides from the course, you can access them from your <a href='#/profile'>profile</a> </p>
        """
      figure: "./images/mini-course/slide-25.jpg"
      figure_credits: ""
