module.exports =
  ...
  K2Page:
    ...
    p1: "The most recent Kepler data, Campaign 1 (C1), is now out on Planet Hunters ready to be classified!  There are three times more stars in C1 than C0, and there's twice as much data for each star (due to the first half of C0 data being unusable), so there's a lot of potential planetary transits to find, in addition to all of the other interesting phenomena possible (eclipsing binaries, variables, etc.).  The planet candidates, along with C0 candidates, will eventually be put on an online catalog of 'Planet Hunters Objects of Interest', which will allow for quick follow-up by the community at large as part of our effort to provide a quicker turnaround for Planet Hunters discoveries.  The work to set up this catalog is ongoing."
    p2: "As a note, we are still limited in the amount of information about the stars that we can show (see Professor Fischer's blog post on C0 here: http://blog.planethunters.org/2014/12/09/just-out-new-data-from-the-kepler-mission/), so we will be unable to most stellar properties when classifying."
    p3: "As before, we would like to thank Dr. Ji Wang for identifying the names of the stars and Andrew Vanderburg from Harvard for providing the clean light-curves."
          ...
          content        :
            ...
            <h2>Science Team</h2>
              <div class="team-members">
                ...
                <div class="team-member">
                  <img src="./images/people/andrew.jpg">
                  <div class="name">Andrew Vanderburg</div>
                  <div class="location">Harvard University (USA)</div>
                  <div class="bio">Andrew is a graduate student at Harvard University who is interested in exoplanet detection and characterization, especially using Kepler and K2 data. He has developed novel data reduction and analysis strategies for K2 data that correct for noise introduced by the spacecraft's motion and restore the quality of K2 data close to that of Kepler.</div>
                </div>
              </div>
          ...
          '''
              ...
              <table>
                <tr>
                  ...
                  <th>Kepler ID</th>
                  <th>Radius of Star</th>
                  <th>Magnitude of Star</th>
              ...
              <table>
                ...
                <tr>
                  <td class="button_row" colspan="4">
                    <button name="calculate-planet" class="button">
                      Calculate
                    </button>
                    <button name="calculate-planet-reset" class="button">
                      Reset
                    </button>
                  </td>
                </tr>
              ...
              <h2>Constants</h2>
                <ul>
                  <li>R<sub>&odot;</sub>: Radius of the Sun =  695,500 km</li>
                  <li>M<sub>&odot;</sub>: Mass of the Sun = 1.99 x 10<sup>30</sup> kg</li>
